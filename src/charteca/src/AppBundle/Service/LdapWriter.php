...
class LdapWriter
{
	...
	public function ajoutEntreeAttributApplicationLocale($username, $appli, $profil, $param1, $param2)
	{
		...
		catch (\Exception $e)
		{
			// Journalise l'erreur
			// Message bref
			$this->logger->critical("LdapWriter::ajoutEntreeAttributApplicationLocale() : \Exception() : " . $e->getMessage());
			// Les détails
			$this->logger->debug("LdapWriter::ajoutEntreeAttributApplicationLocale() : " . $e);
